...
{\sffamily Le but de notre application est de permettre à un utilisateur lambda de trouver, grâce à une recherche rapide et simple, des lieux touristiques et culturels (musées, villages, restaurants, \ldost{}). L'application fonctionne comme un wiki, donc chaque utilisateur peut ajouter un lieu, avec description et photos, ou bien modifier un lieu déjà existant (via un lien << Éditer la fiche >>). Un système de tag a été mis en place.} 
